...
const skills: Skill[] = [
  {
    ...
    subSkills: [
      { label: "Data Cleaning", level: 88 },
      { label: "Pivot Tables", level: 90 },
      { label: "VLOOKUP & HLOOKUP", level: 85 },
      { label: "Data Visualization", level: 82 },
      { label: "Advanced Formulas", level: 84 },
    ],
  },
  {
    name: "Power BI",
    ...
    subSkills: [
      ...
      { label: "DAX Calculations", level: 83 },
      { label: "Data Modeling", level: 85 },
      { label: "Power Query & ETL", level: 80 },
      { label: "KPIs & Metrics", level: 87 },
    ],
  },
  {
    name: "SQL",
    ...
    subSkills: [
      ...
      { label: "CRUD Operations", level: 88 },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Click a skill to explore detailed proficiency breakdown
          </p>
        </motion.div>
                      ...
                      <div className="w-full h-3 rounded-full bg-muted/40 overflow-hidden">
                        <motion.div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 10px ${activeSkill.color}66`,
                          }}
                        />
                      </div>
                    </motion.div>
